...
const {country2, country3}=useContext(UserContext)
...
const show=async()=>{
    try {
        const result = await fetch(`https://air-booking-backend.vercel.app/Spaymentslip/${id}`,{
    method:"get"
})
      ...
      <div style={styles.ticket}>
        ...
        <div style={styles.route}>
          <div style={styles.airport}>
            <div style={styles.airportCode}>{country2}</div>
            <div style={styles.airportName}></div>
          </div>
          <div style={styles.airplaneIcon}>✈</div>
          <div style={styles.airport}>
            <div style={styles.airportCode}>{country3}</div>
            <div style={styles.airportName}></div>
          </div>
        </div>
