                                ...
                                <nav class="menu-nav">
                                    ...
                                    <div class="navbar-wrap main-menu d-none d-lg-flex">
                                        <ul class="navigation">
                                            ...
                                            <li class="active menu-item-has-children"><a>Pages</a>
                                                <ul class="submenu">
                                                    <li class="active"><a href="booking-list.html">Booking List</a></li>
                                                    <li><a href="booking-details.html">Booking Details</a></li>
                                                </ul>
                                            </li>
                                        <Link to="/blog" ><li class="menu-item-has-children"><a >Blog</a>
                                                <ul class="submenu">
                                   ...
                                   <Link to="/register"> <li class="header-btn"><a href="contact.html" class="btn" >Register</a></li></Link>
                                     <Link to="/login"> <li class="header-btn sign-in"><a href="contact.html" class="btn" style={{marginLeft: "10px"}}>Sign In</a></li></Link>
                                        </ul>
                                    </div>
                                </nav>
                            </div>
